                        ...
                        children: [
                          ...
                          TypeAheadField<Data>(
                            ...
                            onSuggestionSelected: (suggestion) {
                              ...
                              latlong = "${suggestion.latitude},${suggestion.longitude}";
                              state = suggestion.subadmin1Code;



                              locationController.text = "${suggestion.name!},${suggestion.stateName!}";
                             selectedLocation = "${suggestion.name!},${suggestion.stateName!}";
                          ...
                          DropdownButtonHideUnderline(
                            child: DropdownButtonFormField<Day>(
                              isExpanded: true,
                              decoration: InputDecoration(
                                contentPadding: EdgeInsets.only(top: 15.sp, bottom: 15.sp, left: 20.w, right: 5.w),
                                filled: true,
                                fillColor: ColorUtility.colorF8FAFB,
                                hintStyle: StyleUtility.hintTextStyle,
                                border: OutlineInputBorder(
