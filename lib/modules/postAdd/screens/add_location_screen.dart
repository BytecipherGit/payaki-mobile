                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SimpleTextField(
                                  ...
                                  hintText: S.of(context).enterYOurBrandName,
                                  titleText:  S.of(context).sellerName,
                        ...
                        CustomButton(
                            ...
                            onTab: () {
                              ...
                              if (location == null) {
                                ...
                                context.flushBarTopErrorMessage(
                                    message:  S.of(context).pleaseSelectExpireDays);
                              } else if (sellerNameController.text.isEmpty) {
                                context.flushBarTopErrorMessage(
                                    message:  S.of(context).pleaseEnterSellerName);
