        ...
        body:SafeArea(
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child:Consumer<TransactionScreenVm>(builder: (context, model, child) {
                              ...
                              return GestureDetector(
                                ...
                                onTap: () {
                                  Navigator.pushNamed(context,
                                      RouteName.transactionDetailScreen,
                                      arguments: {
                                        "transaction":
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            ListView.builder(shrinkWrap: true,
                                              itemCount: 3,itemBuilder: (context, productIndex) {
                                              ...
                                              return Column(crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  ...
                                                  if(productIndex==2)  Text(
                                                 "+2  ${  S.of(context).seeAll}",
                                                    style: StyleUtility
                                                        .titleTextStyle
